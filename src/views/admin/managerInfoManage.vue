    ...
    <div class="ONE">
      <div class="left">
        <p>
          ...
          Management > Administrator Information Management
        </p>
      </div>
      <div class="right">
        <el-input
...
export default {
  ...
  methods: {
      ...
      http({
        ...
        .then((res) => {
          if (res.data.status === 1) {
            console.log(res.data.message, "execution failure");
    ...
    uploadChange(file) {
      ...
      if (!isLt2M) {
        this.$message.error(
          "The uploaded avatar image size cannot exceed 2MB!"
        );
        this.files = [];
        return;
      }
    ...
    handleDelete(index, row) {
      ...
      this.$confirm(
        ...
        .catch(() => {
          this.$message.info("Deletion has been canceled!");
        });
    },
